...
import axiosInstance from "@/service/createtrip/api";
...
const TravelForm = () => {
  ...
  // Here, the POST request is made to the frontend api in service folder
