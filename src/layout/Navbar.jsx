...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#060B12] dark:bg-[#F5F9FF] p-4 md:p-6">
      <div className="flex items-center w-full">
        {/* Logo and Branding with Home Page Link */}
        <div className="flex items-center space-x-2 md:space-x-4">
          <Link
            to="/"
            className="flex items-center space-x-1 md:space-x-2 hover:text-gray-300  dark:text-black transition"
          >
        ...
        <div className="hidden md:flex text-sm flex-grow items-center justify-center space-x-6 ml-6">
          <Link
            to="/create-trip"
            className="text-white dark:text-black font-bold hover:text-gray-300 transition"
          >
            Plan a Trip
          </Link>
          ...
          <div className="flex items-center space-x-4">
            <button className="h-auto p-0 hover:bg-transparent flex items-center space-x-2">
              <Avatar>
                ...
                <AvatarFallback className="bg-gray-200 dark:bg-gray-700 text-black dark:text-white">KK</AvatarFallback>
              </Avatar>
              <ChevronDownIcon
                size={16}
                className="opacity-60 dark:opacity-80 dark:text-black"
                aria-hidden="true"
              />
            </button>
          </div>
